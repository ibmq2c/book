...
3. Add member of **ibmq2c** in **Select members to invite**, and choose the role permission to be **Developer** from GitLab -> Settings -> Members.
...
6. Notify the code assignment is done.
